...
import static software.amazon.freertos.amazonfreertossdk.AmazonFreeRTOSConstants.SCAN_PERIOD;
import static software.amazon.freertos.amazonfreertossdk.AmazonFreeRTOSConstants.UUID_AmazonFreeRTOS;
...
public class AmazonFreeRTOSManager {
     ...
     * service UUID unless setScanFilters was explicitly called. It keeps s1canning for a period of
    ...
    public AmazonFreeRTOSDevice connectToDevice(@NonNull final BluetoothDevice btDevice,
        ...
        new FileUtil().appendLog("AmazonFreeRTOSDevice connectToDevice " + btDevice.getAddress());
