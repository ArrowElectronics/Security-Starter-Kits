...
extern uint32_t __ICFEDIT_LOADER_COM_region_SRAM1_start__;
#define LOADER_COM_REGION_SRAM1_START ((uint32_t)& __ICFEDIT_LOADER_COM_region_SRAM1_start__)
...
extern uint32_t __ICFEDIT_region_DESCRIPTOR_start__;
#define REGION_DESCRIPTOR_START ((uint32_t)& __ICFEDIT_region_DESCRIPTOR_start__)
extern uint32_t __ICFEDIT_region_DESCRIPTOR_end__;
#define REGION_DESCRIPTOR_END ((uint32_t)& __ICFEDIT_region_DESCRIPTOR_end__)
