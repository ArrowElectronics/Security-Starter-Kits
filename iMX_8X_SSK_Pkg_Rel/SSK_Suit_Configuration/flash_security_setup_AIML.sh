...
run_aiml_setup()
{
	...
	echo " "
	openssl req -engine pkcs11 -new -key "pkcs11:model=SLB9670;manufacturer=Infineon;token=greengrass;object=greenkey;type=private;pin-value=1234" -keyform engine -out /greengrass/certs/deviceCert.csr -subj /C="IN"/ST="GUJ"/L="AHM"/O="Arrow"/OU="eic"/CN="SSK"
	echo " "
