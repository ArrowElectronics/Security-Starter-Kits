...
public class CalculateCRC16 {
    ...
    //public final static int POLY = 0x8408;
    public final static int POLY = 0x1021;


    public static int crc16_U(byte[] dataP) {
    ...
    public static String crc16CCITTFalse(byte[] Data) {
        byte[] bytes = Data;
        int crc = 0x0000;
        for (byte b : bytes) {
