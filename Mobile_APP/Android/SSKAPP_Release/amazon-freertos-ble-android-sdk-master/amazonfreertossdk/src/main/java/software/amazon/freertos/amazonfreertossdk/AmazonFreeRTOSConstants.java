...
public class AmazonFreeRTOSConstants {
    ...
    public static final String MUTUAL_AUTH_SERVICE = "c6f2d9e3-49e7-4125-9014-bfc6d669ff00";
    public static final String UUID_WRITE_DATA_INDICATION_SERVICE = "c6f2d9e3-49e7-4125-9014-bfc6d669ff01";
    public static final String UUID_WRITE_DATA_PARAM_VALUE_SERVICE = "c6f2d9e3-49e7-4125-9014-bfc6d669ff02";
    public static final String UUID_CHAR_GATE_WAY_STATUS = "c6f2d9e3-49e7-4125-9014-bfc6d669ff03";
    public static final String UUID_CHAR_EDGE_STATUS = "c6f2d9e3-49e7-4125-9014-bfc6d669ff05";
    public static final String UUID_EDGE_PARAM_VALUE = "c6f2d9e3-49e7-4125-9014-bfc6d669ff04";

    public static final int ERROR_CODE_SERVICE_NOT_FOUND = 0;
    public static final int ERROR_CODE_ECDSA_SIGN_FAIL = 1;
    public static final int ERROR_CODE_ECDH_FAIL = 2;
    //Don't change below code they are defined by ble board
    public static final int ERROR_CODE_BLE_SIGNATURE_RANDOM_PASS = 3;
    ...
    public static final Map<String, String> uuidToName = new HashMap<String, String>() {
        {
            ...
            put(UUID_WRITE_DATA_INDICATION_SERVICE, "CHAR_PARAM");
            put(UUID_WRITE_DATA_PARAM_VALUE_SERVICE, "PARAM_VALUE_SERVICE");
            put(UUID_CHAR_GATE_WAY_STATUS, "CHAR_2_READ");
            put(UUID_EDGE_PARAM_VALUE, "BLE_READ_DATA");
            put(UUID_CHAR_EDGE_STATUS, "UUID_CHAR_EDGE_STATUS");
        }
    };
