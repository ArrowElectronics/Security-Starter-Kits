...
class AWS_IoT_OTA:
    ...
    def BuildFirmwareFileNames(self):
        ...
        self.BUILD_FILE_FULL_NAME=self.BUILD_PATH/Path("aws_demos.sfb")
    ...
    def CreateOTAJob(self):
        ...
        try:
            ...
            updateId="stwb55-"+str(randomSeed) + "-"+self.constants["APP_VERSION_MAJOR"] + "-" + self.constants["APP_VERSION_MINOR"] + "-" + self.constants["APP_VERSION_BUILD"]
