...
echo "Please Collect your Registration Code Provide in SECUITY-STARTER-KIT Portal --> from settings"
...
echo "Copy rootCA.pem and verificationCert.crt into your HOST PC in order to uplode to SECUITY-STARTER-KIT Portal....."
}
